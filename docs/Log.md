Multisign, multi assets, multi payment code programmed and compiled (really hard to overcome the version incompatibilities of cardano-api, even with AI) not yet tested
...
- 26-02-2026  compiling Sync.hs, a cache for utxtos for fast retrieval of wallet assets
- 02-03       testing sync
